...
/** The official agent marks, vendored verbatim from lobe-icons' "Color" variant (MIT;
 *  https://github.com/lobehub/lobe-icons, package static-svg/icons/{claude,codex}-color.svg) —
 *  each agent's real brand color, not a theme-tinted mono glyph. Bundled locally — never fetched
 *  (Electron, no CDN). Note simple-icons carries no OpenAI/Codex marks (removed at the brand
 *  owner's request); lobe-icons is the source for both.
